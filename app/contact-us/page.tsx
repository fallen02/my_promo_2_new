            ...
            <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
              <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                ...
                <p className="relative mt-6 text-lg leading-8 text-muted-foreground sm:max-w-md lg:max-w-none">
                  We’d love to hear from you! Whether you’re interested in a new
                  project, need some creative advice, or simply want to say
                  hello, we’re here and ready to chat.
                </p>
              </div>
