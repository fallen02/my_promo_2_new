...
export function ServiceSection() {
  ...
  return (
    <>
      ...
      From a business website development and SEO to Social Media Marketing and lead generation, we have the expertise to help you achieve your business goals.
      </h3>
