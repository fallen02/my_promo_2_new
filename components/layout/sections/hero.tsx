...
import HeroImage from '@/app/assets/hero section image.jpg'

export const HeroSection = () => {
  return (
    <div className="container max-w-[90%] px-0 lg:px-20 my-[100px] md:my-[160px]">
        ...
        <div className="w-full lg:max-w-full text-center md:text-start z-10">
          ...
          <div className="pl-3 mt-5 flex gap-5">
            <div className="flex flex-col gap-5 bg-accent/30 p-5 rounded-xl backdrop-blur-xl">
              <p className="text-3xl font-openSans text-orange-600 font-semibold">
                Certified
              </p>
